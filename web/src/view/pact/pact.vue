  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="按钮组">
            ...
            <el-button v-auth.not="94" v-if="scope.row.auditType===0" type="text" icon="tools" size="small" @click="handleRowClick(scope.row);changeAuditType1(scope.row);">取消审核</el-button>
            <el-button v-auth.not="94" v-else type="text" icon="tools" size="small" @click="handleRowClick(scope.row);changeAuditType(scope.row);">审核</el-button> 
            </template>
        </el-table-column>
        </el-table>
