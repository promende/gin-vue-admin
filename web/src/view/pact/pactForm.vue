<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="合同类型" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.contractType,"contractType") }}</template>
        </el-table-column>
        <el-table-column align="left" label="合同签署" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.contractSigning,"contractSigning") }}</template>
        </el-table-column>
        <el-table-column align="left" label="是否续签" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.renew,"renew") }}</template>
        </el-table-column>
        <el-table-column align="left" label="关联合同编号" prop="associatedContractNumber" width="180" />
       
        <el-table-column align="left" label="是否中介介入" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.intermediary,"Intermediary") }}</template>
        </el-table-column>
        ...
        <el-table-column align="left" label="交付日" width="180" prop="date" sortable>
            <template #default="scope">{{ formatDate(scope.row.deliveryDate) }}</template>
        </el-table-column>
        <el-table-column align="left" label="合同开始时间" width="180" prop="date" sortable>
            <template #default="scope">{{ formatDate(scope.row.startTime) }}</template>
        </el-table-column>
        <el-table-column align="left" label="合同结束时间" width="180" prop="date" sortable>
            <template #default="scope">{{ formatDate(scope.row.endTime) }}</template>
        </el-table-column>
        <el-table-column align="left" label="支付周期" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.paymentCycle,"paymentCycle") }}</template>
        </el-table-column>
        <el-table-column align="left" label="单价" width="180" prop="date" sortable>
            <template #default="scope">{{ filterDict(scope.row.univalence,"univalence") }}</template>
        </el-table-column>
        <el-table-column align="left" label="合同总金额" width="180" prop="date" sortable>
            <template #default="scope">{{ parseFloat(scope.row.contractGrandTotal).toFixed(2) }}</template>
        </el-table-column>
