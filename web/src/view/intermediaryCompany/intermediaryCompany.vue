  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="按钮组">
            ...
            <el-button v-auth.not="94" type="text" icon="delete" size="small" @click="deleteRow(scope.row)">删除</el-button>
...
export default {
  ...
  methods: {
    async exportExcel() {
      ...
      // console.log(wbout)
      try {
          FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '中介公司台账表.xlsx');
      } catch (e)
      {
